...
int main() {
    ...
    try {
        ...
        if (order1 && order2) {
            ...
            std::cout << "   Order1 and Order2 created with shared_ptr" << std::endl;
        } else {
        ...
        // Test 6: Test Exchange operations
        ...
        std::cout << "Exchange operations are functional with the new smart pointer architecture." << std::endl;
